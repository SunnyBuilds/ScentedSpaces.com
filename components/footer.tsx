      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="font-serif text-xl font-bold text-primary">TechNova</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Your trusted guide to consumer electronics and tech gadgets.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Get the latest tech reviews and gadget recommendations delivered to your inbox.
            </p>
          </div>
        </div>
